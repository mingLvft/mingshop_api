...
import (
	...
	"mingshop_api/order_web/initialize"
	"mingshop_api/order_web/utils"
	"mingshop_api/order_web/utils/register/consul"
	mingshopvalidator "mingshop_api/order_web/validator"
	"os"
	"os/signal"
	"syscall"
)
