...
import (
	...
	"go.uber.org/zap"
	"mingshop_api/order_web/api"
	"mingshop_api/order_web/forms"
	"mingshop_api/order_web/global"
	"mingshop_api/order_web/models"
...
func Detail(ctx *gin.Context) {
	...
	p.NotifyURL = global.ServerConfig.AlipayInfo.NotifyUrl
	p.ReturnURL = global.ServerConfig.AlipayInfo.ReturnUrl
	p.Subject = "明-订单-" + rsp.OrderInfo.OrderSn
