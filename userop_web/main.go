...
import (
	...
	"mingshop_api/userop_web/initialize"
	"mingshop_api/userop_web/utils"
	"mingshop_api/userop_web/utils/register/consul"
	mingshopvalidator "mingshop_api/userop_web/validator"
	"os"
	"os/signal"
	"syscall"
)
